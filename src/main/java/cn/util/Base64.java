...
public class Base64 {
	...
	/**
	 * Bit mask for one character worth of bits in Base64 encoding. Equivalent to
	 * binary value 111111b.
	 */
	private final static int SIX_BIT_MASK = 63;

	/**
	 * Bit mask for one byte worth of bits in Base64 encoding. Equivalent to binary
	 * value 11111111b.
	 */
	...
	/**
	 * Convert a byte to an integer. Needed because in Java bytes are signed, and
	 * for Base64 purposes they are not. If not done this way, when converted to an
	 * int, 0xFF will become -127
	 * 
	 * @param b
	 *            Byte value to be converted
