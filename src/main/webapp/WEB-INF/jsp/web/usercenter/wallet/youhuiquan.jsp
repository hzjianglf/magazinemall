	...
	<c:if test="${type==1}">
		<c:if test="${nowDate } - ${item.endTime} <= 24" var="rs">
			<li>
				...
				<p class="manJian">满${item.manprice }可用</p>
...
<div class="pagenum">
	<page:Page currentIndex="13" url="/usercenter/account/youhuiList?type=${type }" showPageInfo="true" ajaxPager="true" page="${pageInfo }" ajaxUpdateTargetId="youhuiquan"></page:Page>
</div>