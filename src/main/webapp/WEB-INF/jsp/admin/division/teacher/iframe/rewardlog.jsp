	...
	<div style="padding: 15px;" class="layui-anim layui-anim-upbit">
		<div class="yw_cx">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label">打赏描述：</label>
					<div class="layui-input-inline">
	...
	<script type="text/javascript">
		...
		layui.use(['laypage', 'layer', 'table', 'form' ,'laydate'], function(){
			...
			var tableIns = table.render({
				id: 'classlog',
				elem: '#classlog',
				url: '/${applicationScope.adminprefix }/division/rewardlog/listData?userId=${userId}&year=${year}&month=${month}', //数据接口
				where: {},
				page: true, //开启分页
			...
			function effective(id,userId,ratePrice,payTime){
				$.ajax({
					type:'post',
					data:{"id":id,"userId":userId,"ratePrice":ratePrice,"status":1,"payTime":payTime,"statusType":"2"},
			...
			function invalid(id,userId,ratePrice,payTime){
				$.ajax({
					type:'post',
					data:{"id":id,"userId":userId,"ratePrice":ratePrice,"status":0,"payTime":payTime,"statusType":"2"},
