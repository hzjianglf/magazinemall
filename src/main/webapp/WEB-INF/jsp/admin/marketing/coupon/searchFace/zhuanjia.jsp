...
<m:Content contentPlaceHolderId="content">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="numbers" id="numbers" placeholder="" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">作家姓名：</label>
					<div class="layui-input-inline">
						<input type="text" name="names" id="names" placeholder="" autocomplete="off" class="layui-input">
					</div>
				</div>
	...
	<script type="text/html" id="radioCheck">
  		<input type="radio" name="state" value="{{d.userId}}" title="">
	</script>
	...
	<script type="text/javascript">
		...
		layui.use(['laypage', 'layer', 'table', 'form', 'laydate'], function(){
			...
			$("#closeWindow").click(function(){
				...
				var name = $(".layui-form :radio:checked").parent(".layui-table-cell").parent("td").next("td").next("td").find("div").html();//next("td[data-field='name']").child("div").html()
