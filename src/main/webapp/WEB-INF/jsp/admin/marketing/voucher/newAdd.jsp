		...
		<div class="layui-field-box" style=" border-color:#666; border-radius:3px; padding:10px;">
			<form class="layui-form">
            	...
            	<div class="layui-form-item">
					<label class="layui-form-label"><span class="must">*</span>代金券名称：</label>
				...
				<div class="layui-inline">
					...
					<label class="layui-form-label"><span class="must">*</span>代金券面值：&nbsp;</label>
					<div class="layui-input-inline">
						<input type="text" ${type==3?'disabled':'' } lay-verify="man" value="${data.price}" name="price" id="price"  autocomplete="off" class="layui-input" style="width: 170%;">
					</div>
				</div>
				...
				<div class="layui-form-item">
				    <label class="layui-form-label"><span class="must">*</span>代金券状态：</label>
				    <div class="layui-input-block">
	...
	<script type="text/javascript">
		layui.use(['form','laydate','layedit'], function(){
			...
			form.on('submit(addEqBtn)', function(data){
				...
				ajax('/${applicationScope.adminprefix }/voucher/addVoucher', postData, success, 'post', 'json');
				return false;
			})
			//自定义验证规则
			form.verify({
		...
		function search(){
			...
			if(types!='3'){
				...
				openwindow("/voucher/getAllGoods?type="+type+"&searchText="+searchText,text,1000,900,false,function(){
					tableIns.reload({
						page: {
							curr: 1
						}
