...
<m:Content contentPlaceHolderId="content">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="numbers" id="numbers" placeholder="请输入课程编号" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">课程名称：</label>
					<div class="layui-input-inline">
						<input type="text" name="names" id="names" placeholder="请输入课程名称" autocomplete="off" class="layui-input">
					</div>
				</div>
	...
	<script type="text/html" id="radioCheck">
  		<input type="radio" name="state" value="{{d.ondemandId}}" title="">
	</script>
