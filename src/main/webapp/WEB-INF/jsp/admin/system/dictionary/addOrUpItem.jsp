			...
			<form class="layui-form" action="/${applicationScope.adminprefix }/system/dictionary/addOrUpDictionary" method="post">
            	...
            	<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="itemName" lay-verify="required" autocomplete="off" class="layui-input" value="${itemMap.itemName }"/>
					</div>
				</div>
				<c:if test="${itemId ne 0 }">
	            	<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="orderIndex" autocomplete="off" class="layui-input" value="${itemMap.orderIndex }"/>
						</div>
					</div>
				</c:if>
