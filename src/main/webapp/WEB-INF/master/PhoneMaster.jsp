...
<link href="${pageContext.request.contextPath}/js/layer/mobile/need/layer.css" rel="stylesheet" type="text/css" />
<style type="text/css">
...
<body>
	...
	<c:if test="${empty requestScope.footer || requestScope.footer}">
		<footer>
		  <div  class="nav4">
		    <ul class="box">
		    	<li> <a href="/home/index" class="a1"><span>首页</span></a> </li>
          		<li> <a href="/usercenter/node/nodeListFace" class="a2"><span>学习</span></a> </li>
          		<li> <a href="javascript:void(0)" class="yy_biao">播放</a> </li>
          		<li> <a href="/usercenter/order/buglog" class="a3"><span>已购</span></a> </li>
		      	<li> <a href="/usercenter/account/index" class="a4"><span>我的</span></a> </li>
		    </ul>
		  </div>
		</footer>
	</c:if>
	...
	<script src="${pageContext.request.contextPath}/js/layer/mobile/layer.js"></script>
